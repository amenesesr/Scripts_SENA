...
SELECT * FROM (SELECT 	9546814334 AS NIP_clientes,
			...
			"0" AS telefono2_clientes, 
                        "0" AS telefono3_clientes, 
                        "Barranquilla" AS ciudad_clientes,
